...
def labels_parameters(pars):
    ...
    for par in pars_list:
        ...
        if   par == 'f_t_0':
            if not pars['freq-log-scaling']: string = '$f_{1}\ \\mathrm[Hz]$'
            else:                            string = '$\\log f_{1}\ \\mathrm[Hz]$'
        elif par == 'tau_t_0':       string = '$\\tau_{1}\ \\mathrm{[s]}$'
        elif par == 'logA_t_0':      string = '$\\log\ A_{1}$'
        elif par == 'phi_t_0':       string = '$\\phi_{1}$'
        elif par == 'f_t_1':         string = '$f_{2}\ \\mathrm[Hz]$'
        elif par == 'tau_t_1':       string = '$\\tau_{2}\ \\mathrm{[s]}$'
        elif par == 'logA_t_1':      string = '$\\log\ A_{2}$'
        elif par == 'phi_t_1':       string = '$\\phi_{2}$'
        elif par == 'f_t_2':         string = '$f_{3}\ \\mathrm[Hz]$'
        elif par == 'tau_t_2':       string = '$\\tau_{3}\ \\mathrm{[s]}$'
        elif par == 'logA_t_2':      string = '$\\log\ A_{3}$'
        elif par == 'phi_t_2':       string = '$\\phi_{3}$'
        ...
        elif par == 'area_m':      string = '$\\mathcal{A}\ [\\mathrm{km}^2]$'

        elif par == 'A220':        string = '$A_{220}$'
        elif par == 'A2220':       string = '$A_{220}$'
        elif par == 'A2220_1':     string = '$A^{(1)}_{220}$'
        elif par == 'A2220_2':     string = '$A^{(2)}_{220}$'
        elif par == 'A221':        string = '$A_{221}$'
        elif par == 'A2221':       string = '$A_{221}$'
        elif par == 'A2221_1':     string = '$A^{(1)}_{221}$'
        elif par == 'A2221_2':     string = '$A^{(2)}_{221}$'
        ...
        elif par == 'phi2221':     string = '$\\phi_{221}$'
        elif par == 'phi2221_1':   string = '$\\phi^{(1)}_{221}$'
        elif par == 'phi2221_2':   string = '$\\phi^{(2)}_{221}$'
        ...
        elif par == 'f_22':        string = '$f_{22}\ \\mathrm[Hz]$'
        elif par == 'tau_22':      string = '$\\tau_{22}\ \\mathrm{[ms]}$'
        elif par == 'f_220':       string = '$f_{220}\ \\mathrm[Hz]$'
        elif par == 'tau_220':     string = '$\\tau_{220}\ \\mathrm{[ms]}$'
        elif par == 'f_210':       string = '$f_{210}\ \\mathrm[Hz]$'
        elif par == 'tau_210':     string = '$\\tau_{210}\ \\mathrm{[ms]}$'
        elif par == 'f_221':       string = '$f_{221}\ \\mathrm[Hz]$'
        elif par == 'tau_221':     string = '$\\tau_{221}\ \\mathrm{[ms]}$'
        elif par == 'f_330':       string = '$f_{330}\ \\mathrm[Hz]$'
        elif par == 'tau_330':     string = '$\\tau_{330}\ \\mathrm{[ms]}$'
        elif par == 'f_440':       string = '$f_{440}\ \\mathrm[Hz]$'
        elif par == 'tau_440':     string = '$\\tau_{440}\ \\mathrm{[ms]}$'
        elif par == 'f_550':       string = '$f_{550}\ \\mathrm[Hz]$'
        elif par == 'tau_550':     string = '$\\tau_{550}\ \\mathrm{[ms]}$'
        ...
        elif par == 'phase_21':    string = '$\\phi_{21}$'
        elif par == 'phase_33':    string = '$\\phi_{33}$'
        elif par == 'phase_44':    string = '$\\phi_{44}$'
        elif par == 'phase_55':    string = '$\\phi_{55}$'
        ...
        elif par == 'domega_440':  string = '$\\delta\\omega_{440}$'
        ...
        elif par == 'dtau_440':    string = '$\\delta\\tau_{440}$'
...
def labels_legend(par):
    ...
    try:
        ...
        elif par == '22-domega220':                  label = '$(2,2)+\\delta\\omega_{220}$'
        elif par == '22-dtau220':                    label = '$(2,2)+\\delta\\tau_{220}$'
        elif par == '22-domega-dtau220':             label = '$(2,2)+\\delta\\omega_{220}+\\delta\\tau_{220}$'
        ...
        elif par == '22-21-33-44-55-220':            label = '$\mathrm{TEOB\ }(\\ell,m,n) = (2,2,0)$'
        elif par == '22-21-33-44-55-210':            label = '$\mathrm{TEOB\ }(\\ell,m,n) = (2,1,0)$'
        elif par == '22-21-33-44-55-330':            label = '$\mathrm{TEOB\ }(\\ell,m,n) = (3,3,0)$'
        elif par == '22-21-33-44-55-440':            label = '$\mathrm{TEOB\ }(\\ell,m,n) = (4,4,0)$'
        elif par == '22-21-33-44-55-domega-dtau220-220':            label = '$\mathrm{TEOB}+\\delta\\omega_{220}+\\delta\\tau_{220},\,(\\ell,m,n) = (2,2,0)$'
        elif par == '22-21-33-44-55-domega-dtau220-210':            label = '$\mathrm{TEOB}+\\delta\\omega_{220}+\\delta\\tau_{220},\,(\\ell,m,n) = (2,1,0)$'
        elif par == '22-21-33-44-55-domega-dtau220-330':            label = '$\mathrm{TEOB}+\\delta\\omega_{220}+\\delta\\tau_{220},\,(\\ell,m,n) = (3,3,0)$'
        elif par == '22-21-33-44-55-domega-dtau220-440':            label = '$\mathrm{TEOB}+\\delta\\omega_{220}+\\delta\\tau_{220},\,(\\ell,m,n) = (4,4,0)$'
        ...
        elif par == '22-21-33-44-55-domega440':      label = '$(2,2),(2,1),(3,3),(4,4),(5,5)+\\delta\\omega_{440}$'
        elif par == '22-21-33-44-55-dtau440':        label = '$(2,2),(2,1),(3,3),(4,4),(5,5)+\\delta\\tau_{440}$'
        elif par == '22-21-33-44-55-domega-dtau440': label = '$(2,2),(2,1),(3,3),(4,4),(5,5)+\\delta\\omega_{440}+\\delta\\tau_{440}$'
        ...
        elif par == 'IMR-221':                       label = '$\mathrm{IMR\ }(\\ell,m,n) = (2,2,1)$'
        elif par == 'IMR-210':                       label = '$\mathrm{IMR\ }(\\ell,m,n) = (2,1,0)$'
        elif par == 'IMR-200':                       label = '$\mathrm{IMR\ }(\\ell,m,n) = (2,0,0)$'
        elif par == 'IMR-330':                       label = '$\mathrm{IMR\ }(\\ell,m,n) = (3,3,0)$'
        elif par == 'IMR-440':                       label = '$\mathrm{IMR\ }(\\ell,m,n) = (4,4,0)$'
